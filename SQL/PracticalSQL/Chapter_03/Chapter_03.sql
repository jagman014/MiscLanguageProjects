...
-- use bash directories
-- docker cp <file> <target>
-- docker exec -it postgresql bash
-- mkdir /home/postgres/output
-- id postgres
-- chown <uid>:<gid> /home/postgres/output
COPY char_data_types TO '/home/postgres/output/typetest.txt'
...
-- .mode csv
-- .separator "|"
-- .output "C:/YourDirectory/typetest.txt"
