...
-- docker cp <file> <target>
-- file in container bash dir
COPY us_counties_2010
FROM '/home/postgres/input/us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);

-- SQLite: 
-- .open database
-- .mode csv
-- .import "C:/YourDirectory/us_counties_2010.csv" us_counties_2010
...
FROM '/home/postgres/input/supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);

-- SQLite: 
-- .open database
-- .mode csv
-- .import "C:/YourDirectory/supervisor_salaries.csv" supervisor_salaries
...
-- .open database
-- .mode csv
-- .import "C:/YourDirectory/supervisor_salaries.csv" supervisor_salaries_temp
...
COPY us_counties_2010
TO '/home/postgres/output/us_counties_export.txt'
...
-- .mode csv
-- .separator "|"
-- .output "C:/YourDirectory/us_counties_export.txt"
-- SELECT * FROM us_counties_2010;
-- .output stdout
...
TO '/home/postgres/output/us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
-- .mode csv
-- .separator "|"
-- .output "C:/YourDirectory/us_counties_latlon_export.txt"
-- SELECT (geo_name, internal_point_lat, internal_point_lon) FROM us_counties_2010;
-- .output stdout
...
TO '/home/postgres/output/us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
-- .mode csv
-- .separator "|"
-- .output "C:/YourDirectory/us_counties_mill_export.txt"
-- SELECT geo_name, state_us_abbreviation
--    FROM us_counties_2010
--    WHERE geo_name ILIKE '%mill%';
-- .output stdout
