...
SELECT 
    ...
    ,lt.left_school
    ,rt.right_school
FROM schools_left lt 
LEFT JOIN schools_right rt
    ON lt.id = rt.id;
...
SELECT 
    ...
    ,gr.grades
FROM schools_left lt 
LEFT JOIN schools_enrollment en
    ON lt.id = en.id
...
FROM '/mnt/c/Users/jagma/Documents/Coding/MiscLanguageProjects/SQL/PracticalSQL/Chapter_06/us_counties_2000.csv'
