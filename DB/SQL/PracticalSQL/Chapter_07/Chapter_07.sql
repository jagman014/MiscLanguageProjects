...
/*
-- deletes records from reference table
-- when rows from referenced table are deleted
CREATE TABLE registrations (
    registration_id varchar(10)
    ,registration_date date
...
FROM '/mnt/c/Users/jagma/Documents/Coding/MiscLanguageProjects/SQL/PracticalSQL/Chapter_07/city_of_new_york.csv'
